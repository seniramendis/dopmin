  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-1.5 text-sm font-semibold bg-[#F26A10] text-white px-4 py-2 rounded-lg hover:bg-[#d95e0e] transition-colors"
        >
          ...
          >
            <div className="px-6 py-5 flex flex-col gap-4">
              ...
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="text-center text-sm font-semibold bg-[#F26A10] text-white px-4 py-2.5 rounded-lg"
              >
                Book an Audit
              </a>
            </div>
    ...
    <section className="min-h-screen flex items-center justify-center px-6 pt-24 pb-20 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <a
            href="#solutions"
            className="group inline-flex items-center gap-2 bg-[#F26A10] hover:bg-[#d95e0e] text-white font-semibold px-6 py-3 rounded-lg transition-all text-sm"
          >
          ...
          <a
            href="#expertise"
            className="inline-flex items-center gap-2 text-stone-500 hover:text-stone-800 border border-stone-200 hover:border-stone-400 px-6 py-3 rounded-lg transition-all text-sm font-medium"
          >
...
const services = [
  {
    ...
    tag: "PWA Engineering",
    desc: "Progressive Web Apps that work in low-connectivity environments — hospitals, warehouse floors, remote logistics hubs. Your users never see a spinner.",
    barClass: "bg-[#F0E080]",
  ...
  },
  {
    ...
    tag: "LLM Workflows",
    desc: "LLM-powered agents that handle intake, triage, scheduling, and follow-up without a human in the loop — from AI receptionists to autonomous processors.",
    barClass: "bg-[#D94030]",
  ...
  },
  {
    ...
    tag: "Infrastructure",
    desc: "Extract your monolith from on-premise hardware and redeploy as a resilient, auto-scaling cloud architecture on AWS or GCP — zero data loss.",
    barClass: "bg-[#90E060]",
  ...
  },
  {
    ...
    tag: "Commerce Stack",
    desc: "Decouple your frontend from the commerce engine — sub-second page loads, edge-cached product pages, and native app-grade checkout.",
    barClass: "bg-[#F26A10]",
        ...
        >
          {services.map(({ icon: Icon, title, tag, desc, barClass, iconBgClass, iconClass }) => (
            ...
            >
              ...
              <div className={`mt-5 h-0.5 w-8 rounded-full ${barClass}`} />
            </motion.div>
          ))}
        </motion.div>
      </div>
        ...
        >
          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-full mb-4 bg-[#90E060]/10 border border-[#90E060]/40">
    ...
    <footer className="border-t border-stone-100 px-6 py-10 bg-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-stone-300 text-center">
          &copy; {new Date().getFullYear()} DopMin. Enterprise-grade technology, Sri Lanka &amp; Remote.
        </p>
        <div className="flex gap-5 text-xs text-stone-300">
          <a href="#" aria-label="Privacy policy" className="hover:text-stone-500 transition-colors">Privacy</a>
          <a href="#" aria-label="Terms of service" className="hover:text-stone-500 transition-colors">Terms</a>
        </div>
      </div>
    </footer>
  );
