...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-8 md:-mt-12 mx-auto h-[22rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[20px] md:rounded-[30px] shadow-2xl"
    >
